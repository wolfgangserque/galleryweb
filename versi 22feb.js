  ...
  countryDropdown.onChange(() => {
    ...
    if (countryValue === 'Indonesian') {
      ...
      categoryDropdown.options = [
        {label: 'Spine Subspecialists / Neurosurgeons', value: 'spinesubspecialistorneurosurgeon'},
      ...
      categoryDropdown.options = [
        {label: 'Spine Subspecialists / Neurosurgeons', value: 'spinesubspecialistorneurosurgeons'},
